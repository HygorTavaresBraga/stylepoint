            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/camiseta-adidas.jpeg" alt="Camiseta Adidas Originals">
                        </div>
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/vestido-gucci.jpg" alt="Vestido Gucci Jersey Light">
                        </div>
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/conjunto-dior.jpg" alt="Conjunto Dior Pulôver">
                        </div>
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/calca-amiri.jpg" alt="Casaco Amiri">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/dior-oblique.jpg" alt="Dior Oblique Pixel">
                        </div>
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/polo-gucci.jpg" alt="Camisa Gucci Polo">
                        </div>
                ...
                <div class="col-lg-2">
                    <div class="box">
                        ...
                        <div>
                            <img id="img-roupa" src="../img/roupas/boot-gucci.jfif" alt="Gucci Ankle Boot">
                        </div>
